<?php // CONTENT WIDTH & feedlinks
	...
	update_option('siteurl', 'http://www.datvevietjet.net');
	update_option('home', 'http://www.datvevietjet.net');
...
function fullby_theme_page ()
{
	...
	add_theme_page('Theme Options Fullby', 'Theme Options Fullby', 'edit_themes', basename(__FILE__), 'fullby_settings');
